// We have provided the class below. You are expected to provide the
// implementation of the defined interfaces.
struct Logon {
  std::string username;
  std::string password;
};
...
public:
  ...
  void onData(OrderResponse &&response) {
    ...
    // exchange and converted to OrderResponse object. The response object needs
    // to be processed.  you are free to decide which thread would execute this
    // function.
  }
  // send methods sends the request to exchange.
  void send(const OrderRequest &request) {
    // you may assume that this method sends the request to exchange.
    // you DONT have to provide implementation for this method.
    // this method is not thread safe.
    // you are free to decide which thread would execute this function.
  }
  void sendLogon() {
    // you may assume that this method sends the logon message to exchange.
    // you DONT have to provide implementation for this method.
    // this method is not thread safe.
  }
  void sendLogout() {
    // you may assume that this method sends the logout message to exchange.
    // you DONT have to provide implementation for this method.
    // this method is not thread safe.
  }
